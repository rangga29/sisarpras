...
class ConsCategoryCreateRequest extends FormRequest
{
    ...
    {
        return [
            'category_name' => ['required', Rule::unique('cons_categories', 'category_name')],
            'category_slug' => ['required', Rule::unique('cons_categories', 'category_slug')]
        ];
    }
