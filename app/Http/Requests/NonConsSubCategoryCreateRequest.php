...
class NonConsSubCategoryCreateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'sub_category_name' => ['required', Rule::unique('non_cons_sub_categories', 'sub_category_name')],
            'sub_category_slug' => ['required', Rule::unique('non_cons_sub_categories', 'sub_category_slug')]
        ];
    }
