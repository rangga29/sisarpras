...
<x-layout>
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            <div class="btn-group">
                <a href="{{ route('consumable-items.categories.create', $unit->slug) }}" class="btn btn-success">Tambah Data</a>
            </div>
        </div>
    </div>
    <hr />
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="table-actions d-flex align-items-center gap-3 fs-4">
                                    <a href="{{ route('consumable-items.categories.edit', [$unit->slug, $category->category_slug]) }}" class="text-warning"
                                        data-bs-toggle="tooltip" data-bs-placement="bottom" title="Ubah Data">
                                        <i class="bi bi-pencil-fill"></i>
                                    </a>
                                    <form action="{{ route('consumable-items.categories.delete', [$unit->slug, $category->category_slug]) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
