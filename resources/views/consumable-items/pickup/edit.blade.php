...
<x-layout>
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3 fw-semibold">Ubah Data - {{ $pickup->pickup_code }}</div>
        <div class="ps-3">
    ...
    <div class="row">
        <div class="col-lg-12 mx-auto">
            <form class="card" action="{{ route('consumable-items.pickup-items.update', [$unit->slug, $pickup->pickup_code]) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="row g-3">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-12 col-lg-6">
                                            ...
                                            <select class="form-select" name="consumer_id" data-width="100%">
                                                ...
                                                @if(old('consumer_id', $pickup->consumer_id) == $consumer->id)
                                        ...
                                        <div class="col-12 col-lg-6">
                                            ...
                                            <select class="form-select" name="cons_item_id" data-width="100%">
                                                @foreach ($items as $item)
                                                @if(old('cons_item_id', $pickup->cons_item_id) == $item->i_id)
                                        ...
                                        <div class="col-12 col-lg-6">
                                            ...
                                            <input class="form-control @error('pickup_date') is-invalid @enderror" name="pickup_date"
                                                placeholder="Tanggal Ambil" value="{{ old('pickup_date', $pickup_date) }}" data-inputmask="'alias': 'datetime'"
                                        ...
                                        <div class="col-12 col-lg-6">
                                            ...
                                            <input type="number" class="form-control @error('amount') is-invalid @enderror" name="amount"
                                                placeholder="Jumlah Ambil" value="{{ old('amount', $pickup->amount) }}">
                                            @error('amount')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-12">
                                            ...
                                            <textarea class="form-control @error('description') is-invalid @enderror" name="description"
                                                placeholder="Keterangan" rows="3" cols="4">{{ old('description', $pickup->description) }}</textarea>
                                        </div>
