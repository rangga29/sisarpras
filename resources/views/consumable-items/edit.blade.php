...
<x-layout>
    ...
    <div class="row">
        <div class="col-lg-12 mx-auto">
            <form class="card" action="{{ route('consumable-items.update', [$unit->slug, $item->item_code]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="row g-3">
                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12 col-lg-4">
                                            <label for="initial_amount" class="form-label">Jumlah Awal</label>
                                            <input type="number" class="form-control @error('initial_amount') is-invalid @enderror" name="initial_amount"
                                                placeholder="Jumlah Beli" value="{{ old('initial_amount', $item->initial_amount) }}">
                                            @error('initial_amount')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-12 col-lg-4">
                                            <label for="taken_amount" class="form-label">Jumlah Diambil</label>
                                            <input type="number" class="form-control @error('taken_amount') is-invalid @enderror" name="taken_amount"
                                                placeholder="Jumlah Beli" value="{{ old('taken_amount', $item->taken_amount) }}" readonly>
                                            @error('taken_amount')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-12 col-lg-4">
                                            <label for="stock_amount" class="form-label">Jumlah Stok</label>
                                            <input type="number" class="form-control @error('stock_amount') is-invalid @enderror" name="stock_amount"
                                                placeholder="Jumlah Beli" value="{{ old('stock_amount', $item->stock_amount) }}">
                                            @error('stock_amount')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-12 col-lg-4">
                                            ...
                                            <a href="{{ asset('storage/consumable-items/' . $item->receipt) }}" target="_BLANK" class="btn btn-secondary mt-2">
                                                Tanda Terima Barang
                                            </a>
                                        </div>
                                        <div class="col-12">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-12">
                                            ...
                                            <select class="form-select single-select" name="cons_sub_category_id" data-width="100%">
                                                ...
                                                @if(old('cons_sub_category_id', $item->cons_sub_category_id) == $sub_category->sc_id)
