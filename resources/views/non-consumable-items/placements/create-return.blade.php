...
<x-layout>
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3 fw-semibold">Pengembalian - {{ $placement->placement_code }}</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        <a href="{{ route('non-consumable-items.placement-items', $unit->slug) }}">Data Peminjaman</a>
                    </li>
                </ol>
            </nav>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12 mx-auto">
            <form class="card" action="{{ route('non-consumable-items.placement-items.return.store', [$unit->slug, $placement->placement_code]) }}"
                method="POST">
                @csrf
                <div class="card-body">
                    <div class="row g-3">
