...
<x-layout>
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3 fw-semibold">Ubah Data - {{ $sub_category->sub_category_name }}</div>
        <div class="ps-3">
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            <div class="card shadow-none bg-light border">
                                <div class="card-body">
                                    <form class="row g-3"
                                        action="{{ route('non-consumable-items.sub-categories.update', [$unit->slug, $sub_category->sub_category_slug]) }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
                                        <div class="col-12 col-lg-6">
                                            <label for="non_cons_category_id" class="form-label">Kategori</label>
                                            <input type="hidden" name="old_non_cons_category_id" value="{{ $sub_category->non_cons_category_id }}">
                                            <select class="form-select" name="non_cons_category_id" data-width="100%">
                                                @foreach ($categories as $category)
                                                @if(old('non_cons_category_id', $sub_category->non_cons_category_id) == $category->id)
                                        ...
                                        <div class="col-12 col-lg-6">
                                            ...
                                            <input type="hidden" name="old_sub_category_code" value="{{ $sub_category->sub_category_code }}">
                                            <input type="text" class="form-control @error('sub_category_code') is-invalid @enderror" name="sub_category_code"
                                                placeholder="Kode Sub Kategori" value="{{ old('sub_category_code', $sub_category->sub_category_code) }}">
                                        ...
                                        <div class="col-12 col-lg-6">
                                            ...
                                            <input type="text" class="form-control @error('sub_category_name') is-invalid @enderror" name="sub_category_name"
                                                id="sub_category_name" placeholder="Nama Sub Kategori"
                                                value="{{ old('sub_category_name', $sub_category->sub_category_name) }}">
                                        ...
                                        <div class="col-12 col-lg-6">
                                            ...
                                            <input type="text" class="form-control @error('sub_category_slug') is-invalid @enderror" name="sub_category_slug"
                                                id="sub_category_slug" placeholder="Slug Sub Kategori"
                                                value="{{ old('sub_category_slug', $sub_category->sub_category_slug) }}" readonly>
