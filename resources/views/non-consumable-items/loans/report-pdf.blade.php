        ...
        <div class="card-body">
            ...
            <div class="tab-content py-3">
                <div class="tab-pane fade show active" id="semua-data" role="tabpanel">
                    <form action="{{ route('non-consumable-items.loan-items.report.pdf.print', [$unit->slug, 'all']) }}" method="POST" class="forms-sample">
                        @csrf
                        <div class="row mb-3">
                ...
                <div class="tab-pane fade" id="data-tertentu" role="tabpanel">
                    <form action="{{ route('non-consumable-items.loan-items.report.pdf.print', [$unit->slug, 'separate']) }}" method="POST"
                        class="forms-sample">
                        @csrf
                        <div class="row mb-3">
