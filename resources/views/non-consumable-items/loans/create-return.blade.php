...
<x-layout>
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3 fw-semibold">Pengembalian - {{ $loan->loan_code }}</div>
        <div class="ps-3">
    ...
    <div class="row">
        <div class="col-lg-12 mx-auto">
            <form class="card" action="{{ route('non-consumable-items.loan-items.return.store', [$unit->slug, $loan->loan_code]) }}" method="POST">
                @csrf
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-12">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12 col-lg-3">
                                            ...
                                            <select class="form-select" name="con_return_id" data-width="100%">
                                                @foreach ($conditions as $condition)
                                                @if(old('con_return_id') == $condition->id)
                                                <option value="{{ $condition->id }}" selected>{{ $condition->name }}</option>
                                                @else
                                                <option value="{{ $condition->id }}">{{ $condition->name }}</option>
                                                @endif
                                        ...
                                        <div class="col-12 col-lg-3">
                                            ...
                                            <input class="form-control @error('return_date') is-invalid @enderror" name="return_date"
                                                placeholder="Tanggal Pengembalian" value="{{ old('return_date') }}" data-inputmask="'alias': 'datetime'"
