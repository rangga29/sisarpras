        ...
        <div class="card-body">
            <ul class="nav nav-tabs nav-success nav-justified" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link" data-bs-toggle="tab" href="#data-tertentu" role="tab" aria-selected="false">
                        <div class="d-flex align-items-center">
                            <div class="tab-title fw-semibold">DATA TERTENTU [TANGGAL PEMINJAMAN]</div>
                        </div>
                    </a>
                </li>
            </ul>
            <div class="tab-content py-3">
                <div class="tab-pane fade show active" id="semua-data" role="tabpanel">
                    <form action="{{ route('non-consumable-items.loan-items.report.excel.print', [$unit->slug, 'all']) }}" method="POST" class="forms-sample">
                        @csrf
                        <div class="row mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="row col-sm-12 mx-auto">
                                    <div class="col form-check form-check-inline mb-3">
                                        <input type="hidden" name="condition_loan" id="condition_loan" value="0">
                                        <input type="checkbox" class="form-check-input" name="condition_loan" id="all-condition-loan" value="1">
                                        <label class="form-check-label" for="all-condition-loan">
                                            Kondisi Pinjam
                                        </label>
                                    </div>
                                    <div class="col form-check form-check-inline mb-3">
                                    ...
                                    <div class="col form-check form-check-inline">
                                        <input type="hidden" name="loan_date" id="loan_date" value="0">
                                        <input type="checkbox" class="form-check-input" name="loan_date" id="all-loan-date" value="1">
                                        <label class="form-check-label" for="all-loan-date">
                                            Tanggal Pinjam
                                        </label>
                                    </div>
                                    <div class="col form-check form-check-inline">
                ...
                <div class="tab-pane fade" id="data-tertentu" role="tabpanel">
                    <form action="{{ route('non-consumable-items.loan-items.report.excel.print', [$unit->slug, 'separate']) }}" method="POST"
                        class="forms-sample">
                        @csrf
                        <div class="row mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="row col-sm-12 mx-auto">
                                    <div class="col form-check form-check-inline mb-3">
                                        <input type="hidden" name="condition_loan" id="condition_loan" value="0">
                                        <input type="checkbox" class="form-check-input" name="condition_loan" id="separate-condition-loan" value="1">
                                        <label class="form-check-label" for="separate-condition-loan">
                                            Kondisi Pinjam
                                        </label>
                                    </div>
                                    <div class="col form-check form-check-inline mb-3">
                                    ...
                                    <div class="col form-check form-check-inline">
                                        <input type="hidden" name="loan_date" id="loan_date" value="0">
                                        <input type="checkbox" class="form-check-input" name="loan_date" id="separate-loan-date" value="1">
                                        <label class="form-check-label" for="separate-loan-date">
                                            Tanggal Pinjam
                                        </label>
                                    </div>
                                    <div class="col form-check form-check-inline">
