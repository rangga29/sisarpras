...
<x-layout>
    ...
    <div class="row">
        <div class="col-lg-12 mx-auto">
            <form class="card" action="{{ route('non-consumable-items.store', $unit->slug) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row g-3">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12 col-lg-4">
                                            ...
                                            <input type="text" class="form-control @error('item_number') is-invalid @enderror" name="item_number"
                                                placeholder="Nomor Barang" value="{{ old('item_number') }}">
                                            @error('item_number')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea class="form-control @error('include') is-invalid @enderror" name="include" placeholder="Kelengkapan"
                                                rows="3" cols="4">{{ old('include') }}</textarea>
                                        </div>
                                        <div class="col-12">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-12">
                                            ...
                                            <select class="form-select" name="non_cons_sub_category_id" data-width="100%">
                                                ...
                                                @if(old('non_cons_sub_category_id') == $sub->sc_id)
                                        ...
                                        <div class="col-12">
                                            ...
                                            <select class="form-select" name="non_cons_condition_id" data-width="100%">
                                                ...
                                                @if(old('non_cons_condition_id') == $condition->id)
